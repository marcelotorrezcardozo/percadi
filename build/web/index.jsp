                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form action="LoginController" method="post">
                                            <div class="form-group">
                                                <label for="">Email</label>
                                                <input type="text" class="form-control" id="" placeholder="" name="txtEmailEmpresaLogin"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="">Contraseña</label>
                                            <input type="text" class="form-control" id="" placeholder="" name="txtPasswordEmpresaLogin"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <input type="hidden" name="accion" value="loginempresa">
                                        <button type="submit" class="btn btn-default col-lg-12" style="margin-top:18px;">Ingresar</button>
                                    </div>
                                </div>
                                </form>
